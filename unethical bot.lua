...
getgenv().DuoTable = {
    ...
    krone = {
        ...
        "i know you're upset at me || krοne",
        "i hope you fail at going up in life || krοne",
        "best botted server || krοne",
        "i feel more superior when im in your server || krοne",
        "bow down to me || krοne",
        "i hope you like the noise || krοne",
	"dollhouse filled with corny newgens is insane | krοne",
	"u guys really are losers | krοne",
	"go outside | krοne",
	"BOOO 👻👻👻 DOLLHOUSIANS.. OOO IM A JOB APPLICATIONNNN | krοne",
	"cry harder | krοne",
	"braden keep crying we flood ur game | krοne",

    },
    both = {
        "best duo ngl || hate x krοne",
        "nobody can stop us || krοne x hate",
        "its our time now || krοne x hate",
    },
    songTable = {
