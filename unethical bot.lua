...
getgenv().DuoTable = {
    ...
    krone = {
        "best source known to man || krօne",
        "i know you're upset at me || krօne",
        "i hope you fail at going up in life || krօne",
        "best botted server || krօne",
        "i feel more superior when im in your server || krօne",
        "bow down to me || krօne",
        "i hope you like the noise || krօne",
	"dollhouse filled with corny newgens is insane | krօne",
	"u guys really are losers | krօne",
	"go outside | krօne",
	"BOOO 👻👻👻 DOLLHOUSIANS.. OOO IM A JOB APPLICATIONNNN | krօne",
	"cry harder | krօne",
	"braden keep crying we flood ur game | krօne",

    },
    both = {
        "best duo ngl || hate x krօne",
        "nobody can stop us || krօne x hate",
        "its our time now || krօne x hate",
    },
    songTable = {
